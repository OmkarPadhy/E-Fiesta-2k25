...
const Sports = () => {
  ...
  const girlsEvents = [
    ...
    { title: 'Checkmate Clash', image: 'https://i.postimg.cc/2Sh7hB6y/Whats-App-Image-2025-09-20-at-14-07-44-0c6a75a1.jpg', description: 'Chess tournament.', formLink: 'https://forms.gle/CZQdsSx4RzujqApN8', comingSoon: false, closed: true, date: '#', time: '#', venue: '#' },
    { title: 'Chair Chase', image: 'https://i.postimg.cc/3JyBrqQg/IMG-20250920-WA0016.jpg', description: 'Musical chair game (girls only).', formLink: 'https://forms.gle/ED8z1YeaUSVeLtPk7', comingSoon: false, date: '#',closed: true, time: '#', venue: '#' },
