...
const Sports = () => {
  ...
  const boysEvents = [
    ...
    { title: 'Rope Rumble', image: 'https://images.unsplash.com/photo-1692366850335-9415ee4724c8?q=80&w=2166&auto=format&fit=crop', description: 'Tug of war competition.', formLink: 'https://forms.gle/A3sGiHKRjdYHVsa9A', comingSoon: true },
    { title: 'Satolia (ECE Only)', image: 'https://upload.wikimedia.org/wikipedia/commons/b/be/Dabba_Kali2.jpg', description: 'Seven stones (traditional Indian outdoor game).', formLink: '#', comingSoon: true },
    ...
    { title: 'Volley Vibes', image: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?q=80&w=2000&auto=format&fit=crop', description: 'Volleyball competition.', formLink: '#', comingSoon: true },
    { title: 'Power Throw', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYe2dPiALo8j0axXj9UOqwIH8r8EQK-WsYWA&s', description: 'Throw ball contest.', formLink: '#', comingSoon: true },
